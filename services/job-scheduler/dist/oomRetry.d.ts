...
export declare const MAX_OOM_RETRIES = 2;
/** Cause tag recorded on the Estimator_Miss_Record for an OOM_Retry (Req 6.5). */
export declare const OOM_MISS_CAUSE: "OOM";
/**
 ...
 */
export declare function decideOomRetry(currentTier: Tier, oomCount: number): OomDecision;
...
export type OomRetryOutcome = {
    ...
    status: "exhausted";
    error_code: ErrorCode.OOM_RETRY_EXHAUSTED;
};
/**
 ...
 */
export declare function handleOomEvent(event: OomEvent, deps: OomRetryDeps): Promise<OomRetryOutcome>;
